...
export interface ComponentGridItemProps {
  name: string;
  href: string;
  imgProps: ImageProps;
}
export const ComponentGridItem = ({
  ...
  >
    <div className="bg-card text-card-foreground light:border border-border/60 overflow-hidden rounded-xl p-1 shadow-[0px_0px_1px_0px_rgba(25,28,33,0.06),0px_5px_10px_-2px_rgba(106,115,133,0.12),0px_2px_6px_-2px_rgba(0,0,0,0.12)] dark:shadow-[0_-1px_rgba(255,255,255,0.06),0_4px_8px_rgba(0,0,0,0.05),0_0_0_1px_rgba(255,255,255,0.1),0_1px_6px_-4px_#000]">
      <div className="indent-1 text-base leading-[30px]">{name}</div>

      <div className="border-border/40 dark:border-border/10 bg-muted relative aspect-[1.90] overflow-hidden rounded-lg rounded-b-md border">
        {imgProps && (
          <Image
            src={imgProps.src}
            alt={imgProps.alt}
